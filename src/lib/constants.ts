...
// lets the Status column name the forthcoming standard (the draft caveat is
// carried in the chip's hover tooltip, not the visible text). Drop an entry
// once the scheme gains a "FIPS <n>" version in its YAML.
